...
/**
 * Created by liuliang on 2016/11/1.11:45
...
public class WavaBezierProgress extends View implements View.OnClickListener {
    ...
    private int progerssTextSize;
    private int progerssTextLocation;
    ...
    * */
    ...
    public WavaBezierProgress(Context context, AttributeSet attrs) {
        ...
        progress = array.getColor
                (R.styleable.WavaBezierProgress_progress, 0);
        ...
        progerssTextSize = array.getDimensionPixelSize
                (R.styleable.WavaBezierProgress_progressTextSize,DEFAULT_PROGRESS_TESTSIZE);
        progerssTextLocation=array.getDimensionPixelSize
        ...
        mTextPaint.setTextSize(progerssTextSize);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText("" + textc + "%", progerssTextLocation, progerssTextLocation, mTextPaint);
