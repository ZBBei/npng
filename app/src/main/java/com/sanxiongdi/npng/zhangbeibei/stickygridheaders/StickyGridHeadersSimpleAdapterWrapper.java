...
import com.sanxiongdi.npng.zhangbeibei.stickygridheaders.StickyGridHeadersSimpleAdapter;
...
public class StickyGridHeadersSimpleAdapterWrapper extends BaseAdapter implements
        com.sanxiongdi.npng.zhangbeibei.stickygridheaders.StickyGridHeadersBaseAdapter {
    private com.sanxiongdi.npng.zhangbeibei.stickygridheaders.StickyGridHeadersSimpleAdapter mDelegate;

    private HeaderData[] mHeaders;

    public StickyGridHeadersSimpleAdapterWrapper(com.sanxiongdi.npng.zhangbeibei.stickygridheaders.StickyGridHeadersSimpleAdapter adapter) {
        mDelegate = adapter;
