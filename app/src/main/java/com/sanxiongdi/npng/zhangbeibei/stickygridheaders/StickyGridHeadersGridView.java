...
import com.sanxiongdi.npng.zhangbeibei.stickygridheaders.StickyGridHeadersBaseAdapterWrapper;
import com.sanxiongdi.npng.zhangbeibei.stickygridheaders.StickyGridHeadersBaseAdapterWrapper.HeaderFillerView;
...
public class StickyGridHeadersGridView extends GridView implements OnScrollListener,
    ...
    protected com.sanxiongdi.npng.zhangbeibei.stickygridheaders.StickyGridHeadersBaseAdapterWrapper mAdapter;
    ...
    public void setAdapter(ListAdapter adapter) {
        ...
        com.sanxiongdi.npng.zhangbeibei.stickygridheaders.StickyGridHeadersBaseAdapter baseAdapter;
        if (adapter instanceof com.sanxiongdi.npng.zhangbeibei.stickygridheaders.StickyGridHeadersBaseAdapter) {
            baseAdapter = (com.sanxiongdi.npng.zhangbeibei.stickygridheaders.StickyGridHeadersBaseAdapter)adapter;
        ...
        this.mAdapter = new com.sanxiongdi.npng.zhangbeibei.stickygridheaders.StickyGridHeadersBaseAdapterWrapper(getContext(), this, baseAdapter);
    ...
    private int findMotionHeader(float y) {
        ...
        for (int i = getFirstVisiblePosition(); i <= getLastVisiblePosition();) {
            ...
            if (id == com.sanxiongdi.npng.zhangbeibei.stickygridheaders.StickyGridHeadersBaseAdapterWrapper.ID_HEADER) {
    ...
    private void scrollChanged(int firstVisibleItem) {
        ...
        if (childCount != 0) {
            ...
            for (int i = 0; i < childCount; i += mNumMeasuredColumns) {
                ...
                if (mAdapter.getItemId(getPositionForView(child)) == com.sanxiongdi.npng.zhangbeibei.stickygridheaders.StickyGridHeadersBaseAdapterWrapper.ID_HEADER
