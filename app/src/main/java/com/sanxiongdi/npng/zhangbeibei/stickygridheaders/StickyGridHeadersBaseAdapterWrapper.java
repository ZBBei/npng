...
public class StickyGridHeadersBaseAdapterWrapper extends BaseAdapter {
    ...
    private final com.sanxiongdi.npng.zhangbeibei.stickygridheaders.StickyGridHeadersBaseAdapter mDelegate;
    ...
    public StickyGridHeadersBaseAdapterWrapper(Context context, StickyGridHeadersGridView gridView,
                                               com.sanxiongdi.npng.zhangbeibei.stickygridheaders.StickyGridHeadersBaseAdapter delegate) {
        mContext = context;
        mDelegate = delegate;
        mGridView = gridView;
     ...
     */
    public com.sanxiongdi.npng.zhangbeibei.stickygridheaders.StickyGridHeadersBaseAdapter getWrappedAdapter() {
        return mDelegate;
    }
